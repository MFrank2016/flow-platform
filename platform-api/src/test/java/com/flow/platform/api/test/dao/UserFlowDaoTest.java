...
public class UserFlowDaoTest extends TestBase {
    ...
    private final Long mockFlowId = 1L;

    @Test
    public void should_create_user_flow() {
        UserFlow userFlow = new UserFlow(new UserFlowKey(mockFlowId, "liuhailiang@126.com"));
    ...
    public void should_raise_exception_if_create_duplicate_user_flow() {
        ...
        userFlow = new UserFlow(new UserFlowKey(mockFlowId, "liuhailiang@126.com"));
        userFlowDao.save(userFlow);
    }
    ...
    public void should_find_user_flow_by_email_and_delete() {
        ...
        UserFlowKey userFlowKey = new UserFlowKey(mockFlowId, email);
        UserFlow userFlow = new UserFlow(userFlowKey);
        userFlowDao.save(userFlow);

        UserFlowKey userFlowKeyAnother = new UserFlowKey(mockFlowId + 1, email);
    ...
    public void should_delete_user_flow() {
        UserFlowKey userFlowKey = new UserFlowKey(mockFlowId, "liuhailiang@126.com");
        UserFlow userFlow = new UserFlow(userFlowKey);
        userFlowDao.save(userFlow);
    ...
    public void should_get_number_of_user_per_flow() {
        ...
        userFlowKey = new UserFlowKey(mockFlowId, "hello@126.com");
        userFlow = new UserFlow(userFlowKey);
        userFlowDao.save(userFlow);

        Assert.assertEquals(2, userFlowDao.numOfUserByFlow(mockFlowId).longValue());
    }
